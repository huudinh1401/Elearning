...
const reducer = (state = defaultState, action) =>{
    switch (action.type) {
        ...
        case 'LEVEL_CB2': return{ ...state, levelCB2: 0 }
        case 'LEVEL_CUMTU': return{ ...state, levelCumTu: 0 }
        ...
        case 'LEVEL_RUTGON3': return{ ...state, levelRutGon3: 1 }
        case 'LEVEL_RUTGON6': return{ ...state, levelRutGon6: 1 }
        case 'LEVEL_RUTGON9': return{ ...state, levelRutGon9: 1 }
        ...
        case 'IS_CHOOSING_A':
            return { 
                ...state, 
                ChoosingA: true, ChoosingB: false, ChoosingC: false, ChoosingD: false, Choosed: action.Choosed,
            };
        case 'IS_CHOOSING_B':
            return { 
                ...state, 
                ChoosingA: false, ChoosingB: true, ChoosingC: false, ChoosingD: false, Choosed: action.Choosed,
            };
        case 'IS_CHOOSING_C':
            return { 
                ...state,
                ChoosingA: false, ChoosingB: false, ChoosingC: true, ChoosingD: false, Choosed: action.Choosed,
            };
        case 'IS_CHOOSING_D':
            return { 
                ...state, ChoosingA: false, ChoosingB: false,ChoosingC: false, ChoosingD: true, Choosed: action.Choosed,
            };

        case 'IS_CHECKING_TRUE':
            return { 
                ...state,
                Checking: true, textTitle: 'Chính xác', textAnswer: null, backgroundColorChecking: '#66FF00',
            };
        case 'IS_CHECKING_FALSE':
            return { 
                ...state,
                Checking: true, textTitle: 'Đáp án đúng:', textAnswer: action.textAnswer,  backgroundColorChecking: 'red',
            };
